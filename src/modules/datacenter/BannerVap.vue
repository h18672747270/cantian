<template>
  <div class="map-vap flex justify-center items-center w-full h-full"></div>
</template>

<script lang="ts" setup>
import indexVideo from '@/assets/vapAssets/video/datacenter_map.mp4'
// @ts-ignore
import indexJson from '@/assets/vapAssets/json/datacenter_map.json'
// @ts-ignore
...
const handleVap = () => {
  const streamerVapConfig: any = {
    container: document.querySelector('.map-vap'),
    src: indexVideo,
    config: indexJson,
    type: 'streamer',
  }
