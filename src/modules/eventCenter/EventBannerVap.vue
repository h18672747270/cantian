<template>
  <div class="event-banner-vap"></div>
</template>
...
import EventBannerVideo from '@/assets/vapAssets/video/event_banner.mp4'
// @ts-ignore
import EventBannerJson from '@/assets/vapAssets/json/event_banner.json'
// @ts-ignore
...
const handleVap = () => {
  const streamerVapConfig: any = {
    container: document.querySelector('.event-banner-vap'),
    src: EventBannerVideo,
    config: EventBannerJson,
    type: 'streamer',
    loop: true,
  }
